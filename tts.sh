...
inference_nj=48      # The number of parallel jobs in decoding.
...
max_wav_duration=100        # Maximum duration in second.
...
teacher_dumpdir="duration_info" # Directory of teacher outputs (needed if tts=fastspeech).
